...
//| risk management: Better R:R ratios and reduced overtrading.    |
//+------------------------------------------------------------------+
#property copyright "Optimized by Claude Code 2025"
#property link      ""
#property version   "1.00"
#property strict
#property description "BTC Apex - Optimized for A/B testing vs original"
...
input int      MaxOpenPositions = 6;           // Maximum open positions (safer than 20)
...
input int      PatternStrengthThreshold = 42;  // Pattern threshold (42 is breakpoint for trading)
...
void OnTick()
{
    // Emergency stop DISABLED for A/B testing (prevents interference)
